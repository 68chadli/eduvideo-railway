...
def add_to_cart(request, pack_id):
    ...
    messages.success(request, f"✅{pack.nom} a été ajouté à votre panier. Allez dans le menu 🛒 Panier pour finaliser votre commande.</strong>",
    extra_tags='strong persistent')
